            ...
            <section id="cookiesBar" className={cookiesClass}>
                ...
                <div className="container">
                    <div className="cookies__content">
                        <p>
                            By closing this message or clicking Accept, you
                            consent to our cookies on this device in accordance
                            with the cookie policy (
                            <Link to="/cookies-policy">available here</Link>).
                        </p>
                    </div>
                    <div className="cookies__choice">
                        <button
                            className="btn btn--standard mr-16"
                            onClick={this.handleAccept}
                        >
                            Accept
                        </button>
