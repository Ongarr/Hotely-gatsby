        ...
        return (
            <article className="Post">
                <Link to={this.props.article.slug} className="Post__image">
                    <Img
                        fluid={
                            this.props.article.thumbnail.childImageSharp.fluid
                        }
                ...
                <div className="Post__content">
                    <div className="Post__content__header">
                        <time className="post-date caps">
                            {this.props.article.date}
                        </time>
                        {this.props.article.category && (
                            <div className="post-category caps caps--bold">
                                {this.props.article.category}
                            </div>
                        )}
                    </div>
                    ...
                    <Author
                        ...
                        readtime={Helper.calculateReadingTime(
